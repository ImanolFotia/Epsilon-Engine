...
void main()
{
	...
	float metallic = texture(texture_height, TexCoords).x;
    ...
    ExtraComponents.x = metallic;
    ExtraComponents.y = emissive;
	...
	vec3 lambert = light/* * lightcolor*/;

	Color = (vec4(lambert, 1.0));
}
