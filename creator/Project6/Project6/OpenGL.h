...
namespace EpsilonCreator
{
	...
	public ref class COpenGL : public /*System::Windows::Forms::NativeWindow, */System::Windows::Forms::Control
	...
	protected:
		...
		GLint MySetPixelFormat(HDC hdc)
		{
			...
			{
				System::Windows::Forms::MessageBox::Show("ChoosePixelFormat Failed");
				return 0;
			}
			...
			{
				System::Windows::Forms::MessageBox::Show("SetPixelFormat Failed");
				return 0;
			}

			if ((m_hglrc = wglCreateContext(m_hDC)) == NULL)
			{
				System::Windows::Forms::MessageBox::Show("wglCreateContext Failed");
				return 0;
			}

			if ((wglMakeCurrent(m_hDC, m_hglrc)) == NULL)
			{
				System::Windows::Forms::MessageBox::Show("wglMakeCurrent Failed");
				return 0;
			}

			if(!gladLoadGL()) 
			{
				System::Windows::Forms::MessageBox::Show("Failed to initialize GLAD");
				return 0;
			}
