...
Audio::AudioSource(fileName, type, AudioPosition, AudioDirection)
        {
                ...
                try
                {
                        ...
                        //alBufferSamplesSOFT(this->m_BufferID, SoundFile.getSampleRate(), this->m_Format,
SoundFile.getFileSize(),this->m_Channels, AL_UNSIGNED_BYTE_SOFT, data.get()); alBufferData(m_BufferID, m_Format,
data.get(), mAudioResource->FileSize(), mAudioResource->BitRate());
