...
namespace vk
{
	...
	static void createImageViews(VulkanData& vk_data)
	{
		...
		vk_data.defaultRenderPass.renderPassChain.DepthTextureInfo.height = vk_data.swapChainHeight;
		vk_data.defaultRenderPass.renderPassChain.DepthTextureInfo.usage = VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT | VK_IMAGE_USAGE_SAMPLED_BIT;
