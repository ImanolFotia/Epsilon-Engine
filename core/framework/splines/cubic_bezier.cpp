...
namespace framework::splines
{
    ...
    /**
     * @brief Get the first derivative of the bezier curve between the points P0 -> P3, at moment t
     * 
     * @param P0 first point to evaluate
     * @param P1 second point to evaluate
     * @param P2 third point to evaluate
     * @param P3 fourth point to evaluate
     * @param t moment at wich evaluate the derivative
     * @return glm::vec3 value of the first derivative in 3-component vector
     */
