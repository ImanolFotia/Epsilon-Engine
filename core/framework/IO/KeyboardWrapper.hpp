    ...
    namespace Input
    {
        ...
        namespace GLFW
        {
            namespace Key
            {
                ...
                static constexpr int ZERO = GLFW_KEY_0;
                static constexpr int ONE = GLFW_KEY_1;
                static constexpr int TWO = GLFW_KEY_2;
                static constexpr int THREE = GLFW_KEY_3;
                static constexpr int FOUR = GLFW_KEY_4;
                static constexpr int FIVE = GLFW_KEY_5;
                static constexpr int SIX = GLFW_KEY_6;
                static constexpr int SEVEN = GLFW_KEY_7;
                static constexpr int EIGHT = GLFW_KEY_8;
                static constexpr int NINE = GLFW_KEY_9;
                ...
                static constexpr int ARROW_RIGHT = GLFW_KEY_RIGHT;
                static constexpr int ARROW_LEFT = GLFW_KEY_LEFT;
                static constexpr int ARROW_UP = GLFW_KEY_UP;
                static constexpr int ARROW_DOWN = GLFW_KEY_DOWN;

                static constexpr int ADD = GLFW_KEY_KP_ADD;
                static constexpr int SUBTRACT = GLFW_KEY_KP_SUBTRACT;
                static constexpr int MULTIPLY = GLFW_KEY_KP_MULTIPLY;
                static constexpr int DIVIDE = GLFW_KEY_KP_DIVIDE;
