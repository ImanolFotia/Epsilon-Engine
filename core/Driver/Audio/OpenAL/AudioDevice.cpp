...
#undef LOAD_PROC
    ...
    void AudioDevice::list_audio_devices(const ALCchar *devices, const char *message)
    {
    ...
    void AudioDevice::addAudioElement(int ID, std::shared_ptr<AudioSource> element)
    {
        m_AudioElementsCollection[ID] = element;
    }

    void AudioDevice::PlayAudio()
    {
    ...
    void AudioDevice::PlayByID(int ID)
    {
        m_AudioElementsCollection[ID]->Play();
    }

    bool AudioDevice::setMasterVolume(float) { return false; }
    bool AudioDevice::setMusicVolume(float) { return false; }
    bool AudioDevice::setGameVolume(float) { return false; }

    const std::unordered_map<int, std::shared_ptr<AudioSource>> &AudioDevice::getAudioElements()
    {
        return m_AudioElementsCollection;
    }
