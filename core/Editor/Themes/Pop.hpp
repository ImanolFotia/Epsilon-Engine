...
namespace Epsilon::Editor::GUI::Theme::Pop
{
    static void set()
    {
        ...
        //(void)io;
        //auto* font = io.Fonts->AddFontFromFileTTF("./resources/FiraSans-Regular.ttf", 16);
        //io.Fonts->AddFontDefault(font->ConfigData);
    }

    //window padding 8, 7 window border 0 window title align 0.5, 0.5 window border false
}