...
//TODO
//Class to quickly setup an OpenGL element to use inside a Windows Forms App
//Further integration is required, and much of this code belongs in the Context class

namespace Epsilon::Platform::Windows
{
    using namespace System::Windows::Forms;

public
    ref class WindowsFormsComponent : public System::Windows::Forms::Control
    {
    public:
