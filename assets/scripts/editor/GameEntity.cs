...
namespace Editor
{
    ...
    public static partial class Epsilon
    {
        ...
        static Epsilon()
        {
            ...
            string pluginPath = Directory.GetCurrentDirectory() + "/assets/scripts/Game/bin/x64/Debug/net7.0/Game.dll";
        ...
        public unsafe static IntPtr CreateEntity(IntPtr unmanagedObject, IntPtr o_name)
        {
            try
            {
                ...
                obj.InternalPtr = unmanagedObject;
        ...
        public static void ReloadAssemblies()
        {
            ...
            string pluginPath = Directory.GetCurrentDirectory() + "/assets/scripts/Game/bin/Debug/net7.0/Game.dll";
            m_pAssemblies.Clear();
            var assembly = domainMgr.LoadFromAssemblyName(AssemblyName.GetAssemblyName(pluginPath));
